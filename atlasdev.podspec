#
# Be sure to run `pod lib lint atlasdev.podspec' to ensure this is a
...
The test / development version of the Atlas iOS client framework. This won't be released publicly but is being developed to
  ...
  s.author           = { 'Jordan-Campbell' => 'jordan.evan.campbell@gmail.com' }
  s.source           = { :git => 'https://github.com/Jordan-Campbell/atlasdev.git', :tag => s.version.to_s }
